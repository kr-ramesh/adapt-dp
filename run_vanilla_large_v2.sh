#!/bin/bash
#SBATCH --job-name="vanilla-dp-pld-wiki-large"
#SBATCH --time=72:00:00
#SBATCH --output=logs/vanilla_large_pld_512%j.out
#SBATCH --error=logs/vanilla_large_pld_512%j.err
...
echo "/export/fs06/kramesh3/datasets/${DATASET}"
