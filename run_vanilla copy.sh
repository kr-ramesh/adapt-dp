...
#SBATCH --output=logs/vanilla_test%j.out
#SBATCH --error=logs/vanilla_test%j.err
...
SAVEDIR="/export/fs06/kramesh3/dp-fact/vanilla-dp-models/${DATASET}_gpt2_lora_r_${lora_r}_lora_alpha_${lora_alpha}_batchsize_${BATCHSIZE}_epochs_${EPOCHS}_gas_${gradient_accumulation_steps}_noise_multiplier_${noise_multiplier}_sequence_len_${SEQUENCE_LEN}_learning_rate_${LR}"
